          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                fillColor: widget.fillColor ??
                    (widget.isEnable ? R.color.white : R.color.dark12),
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(widget.radius ?? 16.r),
                    borderSide: BorderSide(
                      width: 1,
                      color: widget.colorBorder ?? R.color.white,
                    )),
                    ...
                    : OutlineInputBorder(
                        ...
                        borderSide: BorderSide(
                            color: widget.isErrorEnable
                                ? R.color.dangerColor
                                : widget.enableColorBorder ?? R.color.white),
                      ),
                ...
                labelStyle: widget.style ??
                    Theme.of(context).textTheme.subTitle.copyWith(
                        color:
                            widget.isEnable ? R.color.textDark : R.color.gray),
                hintStyle: widget.hintStyle ??
                    Theme.of(context).textTheme.subTitle.copyWith(
                          color: R.color.greyText,
                        ),
                helperStyle:
                ...
                counterStyle: Theme.of(context)
                    ...
                    .copyWith(
                      color:
                          _reachMaxLength ? R.color.darkRed : R.color.lightGray,
                    ),
            ...
            style: widget.fillBackground
                ? Theme.of(context).textTheme.subTitle.copyWith(
                      color: widget.isEnable ? R.color.dark1 : R.color.dark5,
                    )
                : Theme.of(context).textTheme.subTitle.copyWith(
                      color: widget.isEnable ? R.color.dark1 : R.color.dark5,
                    ),
        ...
        Visibility(
            ...
            child: Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .subTitle12
                  .copyWith(color: R.color.dangerColor),
